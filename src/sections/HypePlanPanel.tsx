    ...
    <div className="space-y-5">
      <div className="card">
        ...
        <p className="text-[var(--text3)] text-xs mb-4">
          Ogni messaggio è ottimizzato per generare DM (lead) — hook esplosivi, corpo breve, CTA con parola d&apos;ordine. La CTA usa <code>@{config.traderName || 'username'}</code> — sostituisci con il tuo handle Telegram reale.
        </p>
